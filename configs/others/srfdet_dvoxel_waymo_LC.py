...
model = dict(
    ...
    img_backbone=dict(
        ...
        init_cfg=dict(type='Pretrained',
                      checkpoint='ckpts/detr3d_resnet101.pth',
                      prefix='img_backbone.'
                      ), ),
    img_neck=dict(
        type='FPN',
...
train_pipeline = [
    ...
    dict(type='LoadMultiViewImageFromFilesCustom', img_scale=(1280, 1920), to_float32=True),
    dict(type='LoadAnnotations3D', with_bbox_3d=True, with_label_3d=True),
    dict(type='ResizeImageMultiViewImage', img_size=[960, 640]),  # (640, 960)
...
log_level = 'INFO'
work_dir = None
load_from = '/home/gopi/PhD/workdirs/SRFDet/srfdet_dvoxel_waymo_L_128dim_loadsamp1_fade/epoch_36.pth'
resume_from = None
workflow = [('train', 1)]
