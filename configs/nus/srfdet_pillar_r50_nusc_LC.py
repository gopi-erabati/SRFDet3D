...
img_norm_cfg = dict(mean=[123.675, 116.28, 103.53], std=[58.395, 57.12, 57.375], to_rgb=True)  # r50
...
model = dict(
    ...
    img_backbone=dict(
        ...
        init_cfg=dict(type='Pretrained',
                      checkpoint='ckpts/sparsefusion_voxel0075_R50.pth',
                      prefix='img_backbone.'
                      ),
    ),
    img_neck=dict(
...
log_level = 'INFO'
work_dir = None
load_from = '/home/gopi/PhD/code/objdet/projects/SRFDet/ckpts/srfdet_pillar_nusc_L_fade_ep20.pth'
resume_from = None
workflow = [('train', 1)]
